 ...
 *
 * Because erasure removes type information, the only methods you can call for an unbounded generic
 * parameter are those available for Object. If, however, you are able to constrain that parameter
 * to be a subset of types, then you can call the methods in that subset. To perform this constraint,
